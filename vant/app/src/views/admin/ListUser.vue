  ...
  <div>
    ...
    >
      <a-form-model :layout="'vertical'" :model="form">
        ...
        <a-form-model-item label="Password">
          <a-input v-model="form.password" type="password" placeholder="nhập password" />
        </a-form-model-item>
    ...
    >
      <a-form-model :layout="'vertical'" :model="form">
        ...
        <a-form-model-item label="Password">
          <a-input v-model="form.password" type="password" placeholder="Để trống nếu không cập nhật" />
        </a-form-model-item>
        <a-form-model-item label="Họ Tên">
          <a-input v-model="form.full_name" placeholder="nhập họ và tên" />
        </a-form-model-item>
